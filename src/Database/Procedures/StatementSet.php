...
class StatementSet implements \Countable, \Iterator, \ArrayAccess {
    ...
    /**
     * Runs {@see PreparedStatement::dumpQuery()} for each PreparedStatement generated by the last call to {@see StatementSet::setStatements()}.
     *
     * This provides an overview of the current execution context for this StatementSet, and may be useful for debugging.
     *
     * @return array The combined results for all dumpQuery() calls
     */
